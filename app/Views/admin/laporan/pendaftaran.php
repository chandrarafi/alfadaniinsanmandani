        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Filter Laporan Pendaftaran</h5>
                </div>
                <div class="card-body">
                    ...
                    <div class="tab-content py-3">
                        ...
                        <div class="tab-pane fade show active" id="harian" role="tabpanel">
                            <form action="<?= base_url('admin/laporan/pendaftaran/harian') ?>" method="post" target="_blank">
                                <div class="row mb-3">
                                    <div class="col-md-4">
                        ...
                        <div class="tab-pane fade" id="bulanan" role="tabpanel">
                            <form action="<?= base_url('admin/laporan/pendaftaran/bulanan') ?>" method="post" target="_blank">
                                <div class="row mb-3">
                                    <div class="col-md-4">
                        ...
                        <div class="tab-pane fade" id="tahunan" role="tabpanel">
                            <form action="<?= base_url('admin/laporan/pendaftaran/tahunan') ?>" method="post" target="_blank">
                                <div class="row mb-3">
                                    <div class="col-md-4">
