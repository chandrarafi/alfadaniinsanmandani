                                ...
                                <form id="loginForm" class="row g-3">
                                    <div class="col-12 mb-3">
                                        ...
                                        <div class="input-group position-relative">
                                            ...
                                            <input type="text" class="form-control" id="email" name="email" placeholder="Masukkan email atau username Anda">
                                        </div>
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <div class="input-group position-relative" id="show_hide_password">
                                            ...
                                            <input type="password" class="form-control border-end-0" id="password" name="password" placeholder="Masukkan password Anda">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#loginForm').submit(function(e) {
                ...
                $.ajax({
                    url: '<?= base_url('auth/processLogin') ?>',
                    type: 'POST',
                    dataType: 'json',
                    data: $(this).serialize(),
                    beforeSend: function() {
                    ...
                    complete: function() {
                        $('button[type=submit]').prop('disabled', false).html('<i class="bx bxs-lock-open"></i> Masuk');
                    },
